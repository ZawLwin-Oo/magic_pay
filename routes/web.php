...
Route::middleware('auth')->namespace('Frontend')->group(function () {
    ...
    Route::get('/transfer_confirm', 'PageController@transferConfirm');
    ...
    Route::get('/transfer_confirm/password-check', 'PageController@passwordCheck');
    ...
    Route::get('/scan_and_pay_confirm','PageController@scanAndPayConfirm');
