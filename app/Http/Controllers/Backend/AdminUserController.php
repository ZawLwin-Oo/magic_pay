...
class AdminUserController extends Controller
{
    ...
    public function ssd(){
        ...
        ->addColumn('action',function($each){
            $edit_icon = '<a href="'.route('admin.admin_user.edit', $each->id).'" class="text-warning"><i class="fas fa-edit"></i></a>';
    ...
    public function store(StoreAdminUser $request){
        ...
        return redirect()->route('admin.admin_user.index')->with('create', 'Successfuly created.');
    }
    ...
    public function update($id, UpdateAdminUser $request){
        ...
        return redirect()->route('admin.admin_user.index')->with('update', 'Successfuly updated.');
    }
